...
namespace GMAO
{
	...
	public partial class stock_reparation_st : Form
	{
		// Token: 0x06000CEB RID: 3307 RVA: 0x001F5C88 File Offset: 0x001F3E88
		public stock_reparation_st()
		{
		...
		// Token: 0x06000CEC RID: 3308 RVA: 0x001F5D0C File Offset: 0x001F3F0C
		private void stock_reparation_st_Load(object sender, EventArgs e)
		{
		}

		// Token: 0x06000CED RID: 3309 RVA: 0x001F5D0F File Offset: 0x001F3F0F
		private void RadGridView1_FilterChanged(object sender, GridViewCollectionChangedEventArgs e)
		{
			this.change_somme();
		}

		// Token: 0x06000CEE RID: 3310 RVA: 0x001F5D1C File Offset: 0x001F3F1C
		private void remplissage_tableau(int o)
		{
			...
			bd bd = new bd();
			string cmdText = "select magasin_sous_traitance.id, ref_interne, article.code_article, article.reference, article.designation, nbr_reparation, activite.designation from magasin_sous_traitance inner join article on magasin_sous_traitance.id_article = article.id inner join activite on magasin_sous_traitance.activite_actuel = activite.id where emplacement_actuel = @m";
			SqlCommand sqlCommand = new SqlCommand(cmdText, bd.cnn);
			sqlCommand.Parameters.Add("@m", SqlDbType.VarChar).Value = "Reparation";
			...
			if (flag2)
			{
				...
				if (flag5)
				{
					this.radGridView1.Rows[stock_reparation_st.row_act].IsCurrent = true;
				}
				bool flag6 = o == 3;
				if (flag6)
				{
					bool flag7 = stock_reparation_st.row_act != 0;
					if (flag7)
					{
						this.radGridView1.Rows[stock_reparation_st.row_act - 1].IsCurrent = true;
					}
					else
					{
						this.radGridView1.MasterTemplate.MoveToFirstPage();
		...
		// Token: 0x06000CEF RID: 3311 RVA: 0x001F609C File Offset: 0x001F429C
		...
		// Token: 0x06000CF0 RID: 3312 RVA: 0x001F6184 File Offset: 0x001F4384
		...
		// Token: 0x06000CF1 RID: 3313 RVA: 0x001F6210 File Offset: 0x001F4410
