namespace GMAO
{
	...
	public partial class parametrage_corrective : global::System.Windows.Forms.Form
	{
		// Token: 0x06000A66 RID: 2662 RVA: 0x0019C404 File Offset: 0x0019A604
		...
		// Token: 0x06000A67 RID: 2663 RVA: 0x0019C43C File Offset: 0x0019A63C
		private void InitializeComponent()
		{
			...
			this.button6.Text = "Gamme Opératoire";
			...
			this.button5.Text = "Plan de maintenance préventive";
			...
			this.button4.Text = "Paramètrage Interventions";
			...
			this.button2.Text = "Classe d'intervention";
			...
			this.button1.Text = "Centre des charges";
			...
			this.button7.Text = "Causes non réalisation";
			...
			base.Name = "parametrage_corrective";
			base.ShowIcon = false;
			base.Load += new global::System.EventHandler(this.parametrage_corrective_Load);
