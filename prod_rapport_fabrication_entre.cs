...
namespace GMAO
{
	...
	public partial class prod_rapport_fabrication_entre : Form
	{
		// Token: 0x06000C4B RID: 3147 RVA: 0x001DFEBC File Offset: 0x001DE0BC
		public prod_rapport_fabrication_entre()
		{
		...
		// Token: 0x06000C4C RID: 3148 RVA: 0x001DFF0F File Offset: 0x001DE10F
		private void prod_rapport_fabrication_entre_Load(object sender, EventArgs e)
		{
			this.select_produit();
		}

		// Token: 0x06000C4D RID: 3149 RVA: 0x001DFF1C File Offset: 0x001DE11C
		private void select_produit()
		{
			this.radGridView1.Rows.Clear();
			bd bd = new bd();
			string cmdText = "select prod_rapport_four_entre.id,id_produit, prod_type_brique.designation, quantite from prod_rapport_four_entre inner join prod_type_brique on prod_rapport_four_entre.id_produit = prod_type_brique.id where id_rapport = @i1 and id_unite = @i2";
		...
		// Token: 0x06000C4E RID: 3150 RVA: 0x001E007C File Offset: 0x001DE27C
			...
			if (flag)
			{
				...
				if (flag4)
				{
					...
					for (int j = 0; j < this.radGridView1.Rows.Count; j++)
					{
						...
						string cmdText2 = "update prod_rapport_four_entre set quantite = @q, tonnage = @t where id = @i";
